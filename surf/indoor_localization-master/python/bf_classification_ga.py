...
# input files
#------------------------------------------------------------------------
path_train = '/Users/skylerbang/surf/indoor_localization-master/data/UJIIndoorLoc/trainingData2.csv ' # '-110' for the lack of AP.
path_validation = '/Users/skylerbang/surf/indoor_lolization-master/data/UJIIndoorLoc/validationData2.csv' # ditto
#------------------------------------------------------------------------
# output files
#------------------------------------------------------------------------
