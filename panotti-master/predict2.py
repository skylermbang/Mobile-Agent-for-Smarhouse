...
def main(args):
    ...
    for infile in args.file:
        if os.path.isfile(infile):
            ...
            if (class_names[ np.argmax(y_proba)] == 'glass'):
                os.system("open /Users/skylerbang/Desktop/1..jpeg")
            if (class_names[ np.argmax(y_proba)] == 'baby'):
                os.system("open /Users/skylerbang/Desktop/2.jpeg")    
            if(class_names[ np.argmax(y_proba)] == 'Glasses'):
                os.system("open /Users/skylerbang/Desktop/1..jpeg")
            outstr = '\n  {\n   "id": "'+str(idnum)+'",\n      "name":"'+infile+'",\n      "tags":[\n   "'+answer+'"]\n  }'
            if (idnum < numfiles-1):
                outstr += ','
